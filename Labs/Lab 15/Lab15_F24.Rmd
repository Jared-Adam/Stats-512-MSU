...
* For two sites that differ by 1 meter in the elevation of the site but are otherwise similar, the [higher/larger] XXXXXX one is estimated to have a mean odds of a site having snow that is XXXX times higher (95% profile likelihood CI from XXXX to XXXXX), controlled for XXXXXXXXXXXX.
