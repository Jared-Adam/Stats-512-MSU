...
* There are some issues with multicollinearity in the model with VIFs of 2.8, 3.5, and 4.43 for elevation, slope, and hydraulic conductivity and the River GVIF that implies an SE inflation of 1.24, suggesting moderate amounts of shared information in the model. Specifically for the hydraulic conductivity (`k_mperd`), the SE for it is 2.104.
...
* $\hat{\mu}\{logpCO2|River,Elevation,StreamOrderF\} = 8.0 -0.68I_{River = YT} - 0.2I_{River = Y} + 0.00_{Elevation} - 0.41I_{StreamOrderF = 2} - 0.25I_{StreamOrderF = 3}$
