...
* $\hat{\mu}\{sittime|influence\ast occlift\}$
...
* For high: $\hat{\mu}\{sittime|influence\ast (occlift = high)\}$

* For moderate: $\hat{\mu}\{sittime|influence\ast (occlift = moderate)\}$

* For rarely: $\hat{\mu}\{sittime|influence\ast (occlift = rarely)\}$
